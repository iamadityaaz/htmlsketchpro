...
function Colorpalette(config) {
  ...
  this.colorBgEl.style.backgroundImage =
    "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAACXBIWXMAABYlAAAWJQFJUiTwAAAAB3RJTUUH4AcGEAAdMvv9RwAAAFBJREFUWMPt18EJACAIhWGLNnJah3Im28B36CDE/66CfBCirYgoa5KZ9hJ3b+vbhgMAAICj5lzNsYrqzxMAAAAAAAAA8/eA2vf8CwAA+B5wAUhhDw4II7MzAAAAAElFTkSuQmCC')";
  ...
  this.colorBgEl.style.borderRadius =
    window.radius + 'px ' + window.radius + 'px 0px 0px';
  ...
  this.paletteIData = this.paletteContext2d.createImageData(
    this.paletteCanvas.width,
    this.paletteCanvas.height
  );
  ...
  this.hueIData = this.hueContext2d.createImageData(
  ...
  this.alphaIData = this.alphaContext2d.createImageData(
    this.alphaCanvas.width,
    this.alphaCanvas.height
  );

  this.alphaCanvas.style.backgroundImage =
    "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAACXBIWXMAABYlAAAWJQFJUiTwAAAAB3RJTUUH4AcGEAAdMvv9RwAAAFBJREFUWMPt18EJACAIhWGLNnJah3Im28B36CDE/66CfBCirYgoa5KZ9hJ3b+vbhgMAAICj5lzNsYrqzxMAAAAAAAAA8/eA2vf8CwAA+B5wAUhhDw4II7MzAAAAAElFTkSuQmCC')";
  ...
  this.alphaCanvas.style.borderRadius =
    '0px 0px ' + window.radius + 'px ' + window.radius + 'px';
  ...
  [this.redInput, this.greenInput, this.blueInput, this.alphaInput].forEach(
    function (inputEl) {
  ...
  function paletteWheel(e) {
    that.pickPalette(
      that.color.saturation - e.deltaX / 2,
      that.color.value - e.deltaY / 2
    );
    e.preventDefault();
  }
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: false, keyCode: 38, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //up
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: false, keyCode: 40, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //down
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: false, keyCode: 37, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //left
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: false, keyCode: 39, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //right
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: true, keyCode: 38, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //shift + up
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: true, keyCode: 40, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //shift + down
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: true, keyCode: 37, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //shift + left
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { altKey: true, keyCode: 39, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //shift + right
...
Object.assign(Colorpalette.prototype, {
  ...
  setAlphaSlider: function setAlphaSlider(alpha) {
    ...
    this.alphaSliderEl.style.left =
      this.alphaCanvas.width * (alpha / 1) - this.width * 0.015 + 'px';
  },
  ...
  setHueSlider: function setHueSlider(hue) {
    'use strict';
    this.hueSliderEl.style.top =
      this.height * (1 / 11) +
      this.hueCanvas.height * (hue / 360) -
      this.height * 0.015 +
      'px';
  },
  ...
  setPalettePointer: function setPalettePointer(s, v) {
    ...
    this.palettePointerEl.style.top =
      -this.height * 0.03 + this.height * (1 / 10) + y + 'px';
  },
  ...
  setColor: function setColor(col, noPropagate) {
    ...
    var rgba = this.getColor();
    this.colorEl.style.backgroundColor =
      'rgba(' +
      rgba.red +
      ',' +
      rgba.green +
  ...
  drawPalette: function drawPalette(hue) {
    ...
    for (x = 0; x < this.paletteCanvas.width; x += 1) {
      for (y = 0; y < this.paletteCanvas.height; y += 1) {
        c = this.HSVtoRGB(
          hue,
          (x / this.paletteCanvas.width) * 100,
          (y / this.paletteCanvas.height) * 100
        );
        this.putPixel(this.paletteIData, x, y, {
          r: c.r,
          g: c.g,
          b: c.b,
          a: 255,
    ...
    case 'swipe-right':
      ...
      el.addEventListener(
        ...
        function (e) {
          ...
          if (
            lastTouchEnd.screenX - firstTouchStart.screenX > swipeThreshold &&
            !getSelectedText() &&
    ...
    case 'tap':
      ...
      el.addEventListener(
        ...
        function (e) {
          ...
          var i;
          for (i = 0; i < e.changedTouches.length; i += 1) {
            e.changedTouches[i].stopPropagation =
              e.stopPropagation && e.stopPropagation.bind(e);
            e.changedTouches[i].preventDefault =
              e.preventDefault && e.preventDefault.bind(e);
            callback(e.changedTouches[i]);
          }
...
function Fontpalette(config) {
  ...
  this.paletteIData = this.previewContext2d.createImageData(
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { shiftKey: false, keyCode: 37, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //left
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { shiftKey: false, keyCode: 39, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //right
...
Object.assign(Fontpalette.prototype, {
  ...
  setSize: function setSize(size) {
    ...
    this.sizeSliderEl.style.left =
      (this.width * (this.size - this.minSize)) /
...
function Imagehost(config) {
  ...
  this.postPdfUrl =
    (NSSketchpad && NSSketchpad.postPdfUrl) ||
    'https://uploader.imagehost.pro:3443/upload';
  this.postImageUrl =
    (NSSketchpad && NSSketchpad.postImageUrl) ||
    'https://uploader.imagehost.pro:3443/upload';
  this.postWebshotUrl =
    (NSSketchpad && NSSketchpad.postWebshotUrl) ||
    'https://uploader.imagehost.pro:3443/webshot?site=';
  this.proxyImageUrl =
    (NSSketchpad && NSSketchpad.proxyImageUrl) || 'https://imagehost.pro/proxy';
  this.proxyExcludedDomain =
    (NSSketchpad && NSSketchpad.proxyExcludedDomain) || 'imagehost.pro';
...
Object.assign(Imagehost.prototype, {
  ...
  dataURItoFile: function dataURItoFile(dataURI) {
    ...
    if (typeof dataURI !== 'string') {
      this.dispatch('error', {
        type: 'upload',
        message: 'dataURI must be a string.',
      });
      return;
    }
  ...
  uploadComplete: function uploadComplete(e) {
    ...
    try {
      ...
      this.dispatch('error', {
        type: 'parse',
        title: 'Upload fail',
        message: 'Uknown response from server.',
        err: err,
      });
    }
    if (response && response.status === 'ok') {
      ...
      this.dispatch('error', {
        ...
        message:
          ...
          'Your upload was rejected by server.',
        response: response,
      });
    }
  },
...
Object.assign(Keyshortcuts.prototype, {
  ...
  onKeyDown: function (e) {
    ...
    for (i = 0; i < this.shortcuts.length; i += 1) {
      ...
      if (
        (!shortcut.pressed || shortcut.repeatable) &&
        this.checkIfPressed(shortcut, e)
      ) {
  ...
  getKeycodeStr: function (keyCode) {
    ...
    switch (keyCode) {
      case 32:
        ...
        break;
      case 91:
        chr = this.isMac() ? '⌘' : 'WIN'; //cmd
        break;
      case 18:
        chr = this.isMac() ? '⌥' : 'ALT'; //alt
        break;
      case 16:
        chr = this.isMac() ? '⇪' : 'SHIFT'; //shift
        break;
      case 17:
        chr = this.isMac() ? 'ctrl' : 'CTRL'; //control
        break;
      case 27:
        chr = 'Esc'; //escape
        break;
      case 20:
        chr = this.isMac() ? '⇪' : 'Caps lock'; //capslock
        break;
      case 13:
        chr = '⏎'; //enter
        break;
  ...
  getShortcutStr: function (shortcut) {
    ...
    if (shortcut.metaKey === true) {
      strParts.push(this.isMac() ? '⌘' : 'WIN');
    }
    if (shortcut.altKey === true) {
      strParts.push(this.isMac() ? '⌥' : 'ALT');
    }
    if (shortcut.ctrlKey === true) {
      strParts.push(this.isMac() ? 'ctrl' : 'CTRL');
    }
    if (shortcut.shiftKey === true) {
      strParts.push(this.isMac() ? '⇪' : 'SHIFT');
    }
    if (shortcut.keyCode) {
  ...
  addShortcut: function addShortcut(shortcut, callbackDown, callbackUp) {
    ...
    if (!typeof callbackDown === 'function') {
      throw new Error(
        'Keyshortcuts::addShortcut(shortcut, callbackDown, callbackUp) - callbackDown must be a function'
      );
    }
...
var NSSketchpad = {
  ...
  watermarkTitle:
    'sketchpad.pro library is available under AGPL-3 license, visit http://developers.sketchpad.pro for source code. This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY.',
  watermarkImageSrc:
...
function Pixelpicker(config) {
  ...
  this.paletteBgEl.style.backgroundImage =
    "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAACXBIWXMAABYlAAAWJQFJUiTwAAAAB3RJTUUH4AcGEAAdMvv9RwAAAFBJREFUWMPt18EJACAIhWGLNnJah3Im28B36CDE/66CfBCirYgoa5KZ9hJ3b+vbhgMAAICj5lzNsYrqzxMAAAAAAAAA8/eA2vf8CwAA+B5wAUhhDw4II7MzAAAAAElFTkSuQmCC')";
  ...
  this.paletteBgEl.style.borderRadius =
    window.radius + 'px ' + window.radius + 'px 0px 0px';
  ...
  img.addEventListener('load', function () {
    ...
    that.paletteContext2d.drawImage(
      img,
      0,
      0,
      img.width,
      ...
      0,
      that.width,
      that.width * (img.height / img.width)
    );
...
Object.assign(Pixelpicker.prototype, {
  ...
  setThresholdSlider: function setThresholdSlider(threshold) {
    'use strict';
    this.thresholdSliderEl.style.left =
      this.width * threshold - this.width * 0.015 + 'px';
  },
...
Object.assign(Resources.prototype, {
  getImage: function getImage(url, callback, onError) {
    ...
    function onImageLoaded(ignore) {
      callback(record);
      that.sketchpad.planRefreshWindow(
        0,
        'resources.js:getImage:onImageLoadedOnce'
      ); //to optimize: refres only if there are new frames
    }
...
function Sketchpad(config) {
  ...
  this.syncNetworkDataFrequency =
    config.syncNetworkDataFrequency || Math.round(1000 / 1);

  this.syncPointerDataFrequency =
    config.syncPointerDataFrequency || Math.round(1000 / 10);
...
Object.assign(Sketchpad.prototype, {
    ...
    config = Object.assign(
      {
        sid:
          ...
          Math.random() +
          'h' +
          (config && config.backgroundPdf && config.backgroundPdf.fingerprint),
      },
      config
    );
  ...
  setSketchConfig: function setSketchConfig(config) {
    ...
    if (config.backgroundImage) {
      ...
      this.background.onload = function () {
        ...
        that.planRefreshWindow(
          0,
          'sketchpad.js:setSketchConfig:background.onload'
        );
      ...
      if (
        this.backgroundImageProgressbar &&
        !this.backgroundImageProgressbar.completed
      ) {
    ...
    if (config.foregroundImage) {
      ...
      this.foreground.onload = function () {
        ...
        that.planRefreshWindow(
          0,
          'sketchpad.js:setSketchConfig:foreground.onload'
        );
      ...
      if (
        this.foregroundImageProgressbar &&
        !this.foregroundImageProgressbar.completed
      ) {
  ...
  getRoomConfig: function getRoomConfig() {
    ...
    config.currentSketchSid =
      (this.room.sketch && this.room.sketch.getId()) ||
      'getRoomConfig-empty-sketch';
  ...
  clearSketchpad: function clearSketchpad() {
    ...
    if (this.backgroundIFrame) {
      if (this.centerViewport) {
        ...
        troX = this.width / 2;
        troY = this.height / 2;
        this.backgroundIFrame.style.transformOrigin =
          troX + 'px ' + troY + 'px';
        this.backgroundIFrame.style.webkitTransformOrigin =
          troX + 'px ' + troY + 'px';
        this.backgroundIFrame.style.MozTransformOrigin =
          troX + 'px ' + troY + 'px';
        this.backgroundIFrame.style.msTransformOrigin =
          troX + 'px ' + troY + 'px';
        this.backgroundIFrame.style.OTransformOrigin =
          troX + 'px ' + troY + 'px';

        this.backgroundIFrame.style.transform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.backgroundIFrame.style.webkitTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.backgroundIFrame.style.MozTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.backgroundIFrame.style.msTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.backgroundIFrame.style.OTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
    ...
    if (this.background) {
      if (this.centerViewport) {
        ...
        this.background.style.webkitTransformOrigin =
          troX + 'px ' + troY + 'px';
        ...
        this.background.style.transform =
          ...
          posY +
          'px)';
        this.background.style.webkitTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.background.style.MozTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.background.style.msTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.background.style.OTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
    ...
    if (this.foreground) {
      if (this.centerViewport) {
        ...
        this.foreground.style.webkitTransformOrigin =
          troX + 'px ' + troY + 'px';
        ...
        this.foreground.style.transform =
          ...
          posY +
          'px)';
        this.foreground.style.webkitTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.foreground.style.MozTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.foreground.style.msTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
          ...
          posY +
          'px)';
        this.foreground.style.OTransform =
          'scale(' +
          1 * this.scale +
          ') rotate(' +
          1 * this.rotation +
    ...
    this.hudsEl.style.transformOrigin =
      this.width / 2 + 'px ' + this.height / 2 + 'px';
    this.hudsEl.style.webkitTransformOrigin =
      this.width / 2 + 'px ' + this.height / 2 + 'px';
    this.hudsEl.style.MozTransformOrigin =
      this.width / 2 + 'px ' + this.height / 2 + 'px';
    this.hudsEl.style.msTransformOrigin =
      this.width / 2 + 'px ' + this.height / 2 + 'px';
    this.hudsEl.style.OTransformOrigin =
      this.width / 2 + 'px ' + this.height / 2 + 'px';

    this.hudsEl.style.transform =
      'scale(' +
      1 * this.scale +
      ') rotate(' +
      1 * this.rotation +
      ...
      -1 * this.viewportY +
      'px)';
    this.hudsEl.style.webkitTransform =
      'scale(' +
      1 * this.scale +
      ') rotate(' +
      1 * this.rotation +
      ...
      -1 * this.viewportY +
      'px)';
    this.hudsEl.style.MozTransform =
      'scale(' +
      1 * this.scale +
      ') rotate(' +
      1 * this.rotation +
  ...
  refreshWindow: function refreshWindow(ignore) {
    //sourceTagInfo
    'use strict';
    ...
    function postponeDrawing(commands, position) {
      ...
      for (
        i = position;
        i < commands.length && i < position + postponeChunkLength;
        i += 1
      ) {
  ...
  syncCanvasFrame: function syncCanvasFrame() {
    ...
    if (this.receivingHistory) {
      this.loadingEl.textContent =
        this.receivingHistoryInputsLoaded +
        '/' +
        this.receivingHistoryInputsTotal;
    }
    ...
    switch (obj.cmd) {
      ...
      case 'set-permissions':
        if (obj.permissions) {
          ...
          console.error(
            'Received not valid permissions in set-permission response'
          );
        }
        break;
      case 'meta':
      ...
      case 'clear-page':
        ...
        if (sketch instanceof Sketch) {
          ...
          this.planRefreshWindow(
            0,
            'sketchpad.js:executeInputCommand:clear-page'
          );
        } else {
      ...
      case 'history-begin':
        ...
        this.loadingEl.style.display = 'flex';
        this.receivingHistoryInputsTotal =
          obj.inputsCount || obj.messagesCount || '?'; //messagesCount is count of all messages including pages, meta etc. may be higher than inputsCount
      ...
      case 'inputs':
        ...
        if (!(sketch instanceof Sketch)) {
          console.warn(
            'cannot find sketch by input sid, creating new sketch',
            '[',
            obj.sid,
            ']'
          );
          //generally this is a fallback. each sketch should be initialised by "page" command
          sketch = this.room.addSketch(
            this,
            Object.assign(this.getSketchConfig(), {
              sid: obj.sid,
            }),
            'remoteSketch'
          );
      ...
      case 'history-end':
        ...
        this.planRefreshWindow(
          0,
          'sketchpad.js:executeInputCommand:history-end'
        );
        break;
      case 'netspeed-end':
      ...
      case 'update-viewport':
        if (obj.user && obj.user.user_id && obj.user.viewport) {
          ...
          console.error(
            'dropping user-viewport, wrong  ``user || user.user_id``'
          );
        }
        break;
      case 'user-bye':
...
function Room(room_token, sketchpad) {
  ...
  if (!(sketchpad instanceof Sketchpad)) {
    throw new Error(
      'Room(room_token, sketchpad)',
      room_token,
      'sketchpad must be instanceof Sketchpad.'
    );
  }
  /**
...
Room.prototype = {
  ...
  addSketch: function addSketch(sketchpad, config) {
    //, remoteSketchFlag
    'use strict';
  ...
  setActiveSketch: function setActiveSketch(sketchpad, sketch) {
    ...
    if (!(sketch instanceof Sketch)) {
      console.error(
        'sketchpad.room.js',
        'setActiveSketch(sketchpad, sketch) - sketch instanceof Sketch is required'
      );
      return;
    }
    sketchpad.sendInputs();
  ...
  removeSketch: function removeSketch(sketchpad, sketch, remoteRemoveFlag) {
    ...
    if (!remoteRemoveFlag && !sketchpad.canDraw()) {
      console.error(
        'Insufficient permissions to perform `removeSketch` operation'
      );
      return;
    }
    if (!(sketch instanceof Sketch)) {
      throw new Error(
        'sketchpad.room.js:removeSketch(sketchpad, sketch, remoteRemoveFlag), sketch must be instanceof Sketch'
      );
    }
    ...
    if (this.sketch === sketch) {
      //if we are removing active sketch
  ...
  addClient: function addClient(user) {
    ...
    pointerEl.style.backgroundColor =
      'rgba(' +
      randomColor.r +
      ', ' +
      randomColor.g +
  ...
  setViewport: function setViewport(viewportEl, user, sketchpad) {
    ...
    viewportEl.querySelector('.username').textContent =
      '' + (user.viewport.away ? '[Away]' : '') + ' ' + user.user_name; // + " " + "(" + viewport.x + ", " + viewport.y + ", " + viewport.width + ", " + viewport.height + ", " + viewport.scale + "/" + sketchpad.scale + ")";
    ...
    viewportEl.style.webkitTransformOrigin =
      viewport.x + 'px ' + viewport.y + 'px';
    viewportEl.style.MozTransformOrigin =
      viewport.x + 'px ' + viewport.y + 'px';
...
function Sketch(config) {
  ...
  this.config = Object.assign(
    ...
    config
  ); // sketch config like viewport position, scale, tools, background, foreground, ...
...
Object.assign(Sketch.prototype, {
    ...
    for (i = 0; i < data.length; i += 1) {
      for (ii = 0; ii < data[i].evs.length; ii += 1) {
        ...
        if (data[i].evs[ii].cid !== undefined) {
          Object.assign(
            data[i].evs[ii],
            this.getCachedFrame(data[i].evs[ii].cid)
          );
        }
        data[i].cmd = 'inputs';
  ...
  cacheFrame: function cacheFrame(tool) {
    ...
    var i = this.toolsCache.findIndex(function (el) {
      ...
      if (
        ...
        el.hgt === tool.hgt &&
        el.wdh === tool.wdh &&
        JSON.stringify(el.cnf) === JSON.stringify(tool.cnf)
      ) {
        //to optimize
        return true;
      } else {
   ...
   * @return {undefined}                  [description]
   */
  grindBulkFrame: function grindBulkFrame(
    sketchpad,
    bulkFrame,
    receivingHistory
  ) {
  ...
  undoSketch: function undo(sketchpad, uid) {
    ...
    function removeFromStack(stack, uid, bid) {
      ...
      for (last = last - 1; last > -1; last -= 1) {
        if (
          (!bid && stack[last].uid === uid) ||
          (stack[last].uid === uid && stack[last].bid === bid)
        ) {
          ...
          for (i = 0; i < undoFrame.evs.length; i += 1) {
            if (undoFrame.evs[i].cid !== undefined) {
              Object.assign(
                undoFrame.evs[i],
                that.getCachedFrame(undoFrame.evs[i].cid)
              );
            }
          }
  ...
  setToolConfig: function setToolConfig(config) {
    ...
    if (config.color) {
      switch (typeof config.color) {
        case 'string':
          match = String(config.color).match(
            /([0-9]+),([0-9]+),([0-9]+),([0-9\.]+)/
          );
          col = {
  ...
  setToolConfig: function setToolConfig(config) {
    ...
    if (config.fillColor) {
      switch (typeof config.fillColor) {
        case 'string':
          match = String(config.fillColor).match(
            /([0-9]+),([0-9]+),([0-9]+),([0-9\.]+)/
          );
          col = {
            r: parseInt(match && match[1]) || 0,
...
Object.assign(ToolCirc.prototype, {
  ...
  moveInput: function drawPath(input, x, y, e) {
    ...
    if (this.sketchpad.centerViewport) {
      input.selectorDiv.style.left =
        this.sketchpad.width / 2 + fristX - w + 'px';
      input.selectorDiv.style.top =
        this.sketchpad.height / 2 + fristY - h + 'px';
      input.selectorDiv2.style.left =
        this.sketchpad.width / 2 + fristX - w + 'px';
      input.selectorDiv2.style.top =
        this.sketchpad.height / 2 + fristY - h + 'px';
    } else {
    ...
    for (ll = 0; ll < toolConfig.lay.length; ll += 1) {
      ...
      if (points && points.x && points.y && points.x.length > 1) {
        for (l = 1; l < points.x.length; l += 1) {
          ...
          context.lineWidth =
            toolConfig.siz + 100 / (10 + this.distance(p1.x, p1.y, p2.x, p2.y));
      ...
      if (points && points.x && points.x.length > 1) {
        for (l = 1; l < points.x.length; l += 1) {
          ...
          context.lineWidth =
            toolConfig.siz / 2 +
            toolConfig.siz /
              (toolConfig.siz / 5 + this.distance(p1.x, p1.y, p2.x, p2.y) / 10);
          context.moveTo(p1.x, p1.y);
          context.lineTo(p2.x, p2.y);
          context.stroke();
        }
  ...
  this.sketchpad.containerEl.addEventListener('drop', function (e) {
    ...
    if (files.length > 0) {
      ...
      if (
        ...
        (file.type.indexOf('image') !== -1 || file.type.indexOf('pdf') !== -1)
      ) {
        window.tmp = new Imagehost({
          progressParentEl: sketchpad.progressParentEl || sketchpad.containerEl,
          file: file,
...
Object.assign(ToolImage.prototype, {
  ...
  moveInput: function drawPath(input, x, y, e) {
    ...
    if (
      Math.abs(firstX - x) < this.fieldThreshold ||
      Math.abs(firstY - y) < this.fieldThreshold
    ) {
  ...
  drawFramePath: function drawFramePath(config, points) {
    ...
    function drawImage(img) {
      ...
      for (ll = 0; ll < toolConfig.lay.length; ll += 1) {
        ...
        p1 = {
          x: Math.min(points.x[0], points.x[1]),
          y: Math.min(points.y[0], points.y[1]),
        };
        p2 = {
          x: Math.max(points.x[0], points.x[1]),
          y: Math.max(points.y[0], points.y[1]),
        };
        ...
        context.drawImage(img, p1.x, p1.y, w, h);
        context.restore();
      }
    }
    var that = this;
...
Object.assign(ToolLine.prototype, {
  ...
  moveInput: function drawPath(input, x, y, e) {
    ...
    if (e.shiftKey) {
      ...
      var angle =
        Math.round(Math.atan2(dx, dy) / (Math.PI / 4)) * (Math.PI / 4);
...
Object.assign(ToolRotateViewport.prototype, {
  ...
  moveInput: function moveInput(input, x, y, e) {
    ...
    var theta =
      ...
      (Math.atan2(input.startX, input.startY) * 180) / Math.PI;
    if (e.shiftKey) {
...
Object.assign(ToolType.prototype, {
  ...
  startInput: function startPath(id, x, y, e) {
    ...
    if (this.sketchpad.centerViewport) {
      ...
      input.typeInput.style.top =
        this.sketchpad.height / 2 + y - this.getSize() / 2 + 'px';
    } else {
...
function Thickness(config) {
  ...
  function changeSizeEvent(e) {
    ...
    var size =
      that.minValue + (y / that.height) * (that.maxValue - that.minValue);
    that.setSize(size);
  }
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { shiftKey: false, keyCode: 38, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //up
  ...
  this.keyshortcuts.addShortcut(
    Object.assign(
      { shiftKey: false, keyCode: 40, repeatable: true },
      config.keyModifiers
    ),
    function () {
      //down
...
Object.assign(Thickness.prototype, {
  ...
  setSize: function setSize(size) {
    ...
    this.sliderEl.style.top =
      (this.height * (this.size - this.minValue)) /
